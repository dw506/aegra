...
class MissionPlannerResult(PlannerResult):
    """Legacy compatibility wrapper for the old PlannerResult contract."""
...
class MissionPlannerAgent:
    ...
    def run(
        ...
        *,
        ...
        if hasattr(self._advisor, "propose_next_decision"):
    ...
    def run_legacy_stage_tasks(
        ...
        *,
        ...
        """Legacy compatibility: return old PlannerResult/StageTask output."""
