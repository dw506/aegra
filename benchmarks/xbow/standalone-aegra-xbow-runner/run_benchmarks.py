#!/usr/bin/env python3
"""
Robust benchmarking script for Aegra against XBOW benchmarks.
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Run Aegra benchmarks against XBOW validation suite",
...
def auto_detect_benchmarks_dir() -> Path:
    ...
    candidates = [
        script_dir.parent.parent / "PentestGPT" / "benchmark" / "xbow-validation-benchmarks" / "benchmarks",
        script_dir.parent / "xbow-validation-benchmarks" / "benchmarks",
        script_dir.parent / "xbow-benchmarks" / "benchmarks",
    ]
